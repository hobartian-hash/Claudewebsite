...
Project memory for **The Sunday Letterbox** — a weekly essay newsletter by Tim Hynes in Hobart.
...
Renamed from On Purpose to Chosen Out Loud and then to The Sunday Letterbox, August 2026 — see NAMING-REVIEW.md and NAMING-ALTERNATIVES.md. Palette, typefaces, portrait rules and email rules carried over unchanged through both renames.
